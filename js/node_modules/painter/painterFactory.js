...
function PainterFactory(/* Raphael */ p_paper) {
...
function painterFactory(/* Raphael */ p_paper) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            var PARAM = p_paper; if ( !(PARAM instanceof Raphael) ) { throw new Error('type error: param p_paper should be of type Raphael', p_paper); }
        /* @DEVELOPMENT } */
        return new PainterFactory(p_paper);
    }
}
...
PainterFactory.prototype.forObject = function(/* object */ p_object) {
    ...
    if ( p_object instanceof m_textNode.TextNode ) {
        return m_textNodePainter.textNodePainter(p_object, this._paper);
    } else if ( p_object instanceof m_map.Map ) {
        return m_mapPainter.mapPainter(p_object, this._paper);
    /*
    } else if ( p_object instanceof m_area.Area ) {
        return m_areaPainter.areaPainter(p_object, this._paper);
