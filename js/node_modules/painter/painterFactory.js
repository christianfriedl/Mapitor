...
function PainterFactory(/* m_map.Map */ p_map, /* optional */ p_paper) {
...
PainterFactory.prototype.forObject = function(/* m_node.Node */ p_object) {
    ...
    if ( p_object instanceof m_textNode.TextNode ) {
        return m_textNodePainter.textNodePainter(this._map.widget(p_object), this._paper);
    } else if ( p_object instanceof m_area.Area ) {
        return m_areaPainter.areaPainter(this._map.widget(p_object), this._paper);
    } else if ( p_object instanceof m_arrow.Arrow ) {
        return m_arrowPainter.arrowPainter(this._map.widget(p_object), this._paper);
    } else {
