...
function AreaPainter(/* m_nodeWidget.NodeWidget */ p_widget, /* Raphael */ p_paper) {
...
function areaPainter(/* m_nodeWidget.NodeWidget */ p_widget, /* Raphael */ p_paper) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            ...
            var PARAM = p_widget; if ( !(PARAM instanceof m_areaWidget.AreaWidget) ) { throw new Error('type error: param p_widget should be of type m_areaWidget.AreaWidget'); }
        /* @DEVELOPMENT } */
        return new AreaPainter(p_widget, p_paper);
    } else {
...
AreaPainter.prototype.paint = function() {
    ...
    _(this._node.nodes()).each(function(n) {
        ...
        _(_(n.arrows()).select(function(a) {
            return !( _(seenArrows).contains(a) );
        }.bind(this))).each(function(a) {
            n.map().painter(a).paint();
            seenArrows.push(a);
        }.bind(this));
    }.bind(this));
};
