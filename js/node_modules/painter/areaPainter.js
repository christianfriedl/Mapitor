...
AreaPainter.prototype.paint = function() {
    ...
    var r = this._paper.rect(this._node.x(), this._node.y(), this._node.width(), this._node.height());
    r.attr({ 'stroke': '#ccc', 'fill': '#fff', 'fill-opacity': 0 });
    _(this._node.nodes()).each(function(n) {
        var pf = m_painterFactory.painterFactory(this._paper);
