...
function TextNodePainter(/* m_nodeWidget.NodeWidget */ p_widget, /* Raphael */ p_paper, /* dom element */ p_parent) {
...
function textNodePainter(/* m_nodeWidget.NodeWidget */ p_widget, /* Raphael */ p_paper, /* dom el */ p_parent) {
    if ( arguments.length > 0 ) {
        /* @DEVELOPMENT { */
            var LEN = 3; if ( arguments.length !== LEN ) { throw new Error('arguments length is ' + arguments.length + ', should be ' + LEN); }
            var PARAM = p_widget; if ( !(PARAM instanceof m_textNodeWidget.TextNodeWidget) ) { throw new Error('type error: param p_widget should be of type m_textNodeWidget.TextNodeWidget'); }
        ...
        return new TextNodePainter(p_widget, p_paper, p_parent);
    } else {
