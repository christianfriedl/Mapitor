...
UI.prototype.doTest = function() {
    ...
    var m_cntc = require('command/createTextNodeCommand.js');
    var ctnc = m_cntc.createTextNodeCommand(this._map, this._map.area());
    ctnc.run();
    this._map.focusedNode().text('ctnc created');
    var m_dnc = require('command/DeleteNodeCommand.js');
    var dnc = m_dnc.deleteNodeCommand(this._map, this._map.focusedNode());
    dnc.run();
    /*
            ...
            switch ( key.char ) {
                case m_keyboardEventMapper.Keys.tab:
                    if ( key.shift ) {
                        ...
                        var cmd = m_createTextNodeCommand.createTextNodeCommand(this._map, this._map.area());
                        cmd.run();
                        this.layout();
                        this.paint();
                        var pf = m_painterFactory.painterFactory(this._map, this._paper);
                        this.editTextNode(this._map.focusedNode(), pf.forObject(this._map.focusedNode()));
