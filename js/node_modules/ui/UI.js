...
UI.prototype.prepareTest = function() {
    var m_textNode = require('node/textNode.js');
    var m_textNodePainter = require('painter/textNodePainter.js');
    var tn = m_textNode.textNode(this._map, this._map.area(), { text: 'textiii', x: 100, y: 100, width: 100, height: 40 });
    this._map.area().addNode(tn);
    var tn2 = m_textNode.textNode(this._map, this._map.area(), { text: 'textiii 2', x: 100, y: 150, width: 100, height: 40 });
    this._map.area().addNode(tn2);
};

UI.prototype.paint = function() {
    var m_painterFactory = require('painter/painterFactory.js');
    var painter = m_painterFactory.painterFactory(this._map, this._paper).forObject(this._map);
    painter.paint();
};
