...
/* array(m_nodeWidget.NodeWidget) */ Map.prototype.widgets = function() {
    return _(this._widgets).values();
};
...
Map.prototype.scrollTo = function(/* number */ p_x, /* number */ p_y) {
    window.mapitor.ui.paper().setViewBox(p_x, p_y, window.mapitor.ui.domWidth(), window.mapitor.ui.domHeight(), false);
    this._scrollX = p_x;
    this._scrollY = p_y;
};
Map.prototype.zoom = function(/* number */ p_factor) {
    window.mapitor.ui.paper().setViewBox(this._scrollX, this._scrollY, window.mapitor.ui.domWidth() * p_factor, window.mapitor.ui.domHeight() * p_factor, false);
};
