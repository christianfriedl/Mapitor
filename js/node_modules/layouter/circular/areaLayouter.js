...
AreaLayouter.prototype._layoutFromNode = function(/* m_node.Node */ p_node) {
    ...
    console.log('putting', p_node.text(), 'on circlePos', circlePos);
...
/* { circleNr, pos } */ AreaLayouter.prototype._findFirstFreePosition = function() {
    for ( var i = 0; i < this._circles.length; ++i ) {
        ...
        if ( pos !== undefined ) {
            console.log('_findFirstFreePosition returns ', { circleNr: i, pos: pos });
            return { circleNr: i, pos: pos };
        }
    }
    var c = this._createCircle(i);
    console.log('_findFirstFreePosition created circle', c);
...
Circle.prototype.findFreePosition = function() {
    console.log('ffp poscount', this.positionCount(), 'positions', this._positions);
    ...
    for ( var i=0; i < this._positions.length - 1; ++i ) {
        ...
        res[med] = diff;
        // console.log('ffp setting med', med, 'to diff', diff, 'res now', res, 'i', i, this._positions[i], this._positions[i+1]);
    }
